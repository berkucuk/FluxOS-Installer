...
var translations = {
    ...
    zh_TW: {
        ...
        publicIPv6: "公開IPv6",
        loading: "載入中...",
        notConnected: "未連線至網際網路",
        showCountryFlag: "顯示國旗：",
        showIPType: "顯示IP類型（區網/公開）：",
        textColor: "文字顏色：",
        showFlagOnly: "僅顯示公開IP的國旗：",
        ipCopied: "IP位址已複製到剪貼簿",
        noIPToCopy: "沒有可複製的IP位址",
        copyError: "錯誤：無法複製IP位址",
        flagPosition: "國旗位置：",
        flagRight: "靠右",
        flagLeft: "靠左",
        networkInterface: "可用介面：",
        customPrefix: "客製化前綴：",
        customPrefixPlaceholder: "輸入要在IP前顯示的文字",
        noInterfaceSelected: "未選擇介面",
        currentInterface: "目前介面",
        disconnectedTextColor: "斷線的文字顏色：",
    },
    ko: {
        localIP: "로컬 IP",
        localIPv6: "로컬 IPv6",
